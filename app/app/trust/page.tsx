...
const TRUST_SECTIONS = [
  ...
  ["Synthetic sample data policy", "All JanusScope defaults, demos, templates, and examples should use synthetic project names, companies, addresses, and people."],
  ...
  return (
    <div className="mx-auto max-w-[1180px] space-y-8">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-semibold text-ink">Plain-language guidance for synthetic demos and project information</h1>
      ...
      <div className="grid gap-4">
        {SYNTHETIC_DATA_GOVERNANCE_PROMISES.map((point) => (
          <div className="card p-5 text-sm font-semibold leading-6 text-ink" key={point}>
            {point}
          </div>
        ))}
      </div>
