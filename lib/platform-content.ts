...
export const TRADE_RISKS: TradeRiskDefinition[] = [
  ...
  },
  {
    ...
    reviewMode: "Cabinets / Countertops Reviewer",
    summary: "Use when field measurements, cutouts, fillers, substrate, and occupied-unit access can turn a simple package into rework.",
    commonMisses: ["Field measurements", "Scribe and filler responsibility", "Backsplash and side splash", "Sink and appliance cutouts", "Hardware and pulls"],
    badExclusions: ["Template trips excluded", "Blocking excluded", "Wall repairs after removal excluded", "Caulking left vague"],
    hiddenCosts: ["Out-of-square walls", "Lead times", "Damaged existing substrate", "Occupied-unit access delays"],
    coordinationIssues: ["Plumbing rough-in", "Electrical devices", "Appliance dimensions", "Wall patching and paint"],
    questions: ["Who owns field measuring and template trips?", "Are blocking, fillers, cutouts, hardware, and caulking included?", "How are damaged walls or substrate handled?"],
    alternates: ["Solid surface alternate", "Hardware package alternate"],
    allowances: ["Allowance for substrate repair", "Allowance for field-driven filler revisions"],
    changeOrderTriggers: ["Field dimensions differ", "Substrate damage discovered", "Appliance dimensions change"],
    inspectionConcerns: ["Clearances", "Accessible cabinet locations if applicable", "Sealant and water exposure areas"],
    closeoutItems: ["Care instructions", "Warranty data", "Attic stock or spare parts if required"],
    bidFormBreakouts: ["Cabinets", "Countertops", "Backsplash", "Cutouts", "Hardware", "Template trips", "Caulking", "Substrate repair allowance"],
    suggestedPrompts: ["Review cabinet and countertop scope", "Build cabinet bidder questions"],
    suggestedTemplates: ["Trade bid form", "Scope gap matrix"],
    suggestedChecklist: ["Verify field measurements", "Verify cutouts", "Verify fillers", "Verify utility coordination"],
  },
  {
    slug: "drywall-paint",
    title: "Drywall / Paint",
    trade: "Drywall / Paint",
    reviewMode: "Drywall / Paint Scope Reviewer",
    summary: "Use when patch-to-match language, finish level, fire-rated assemblies, and repeated mobilizations are easy to undercarry.",
    commonMisses: ["Patch-to-match limits", "Fire-rated assemblies", "Primer and finish system", "Texture matching", "Occupied protection"],
    badExclusions: ["Fire caulk excluded", "Backing excluded", "Protection excluded", "Touch-up only language"],
    hiddenCosts: ["Multiple mobilizations", "Substrate repairs", "Color matching", "Resident access delays"],
    coordinationIssues: ["Electrical and plumbing penetrations", "Door and cabinet interfaces", "Flooring/base sequence", "Punch list standards"],
    questions: ["What finish level and paint system apply?", "Who owns substrate repair before paint?", "Which assemblies are rated and who owns firestopping?"],
    alternates: ["Level 5 finish alternate", "Full repaint alternate"],
    allowances: ["Allowance for substrate repair", "Allowance for occupied-unit protection"],
    changeOrderTriggers: ["Unexpected wall damage", "Finish standard changes", "Additional patch locations"],
    inspectionConcerns: ["Rated assembly continuity", "Moisture-resistant board locations", "Finish quality"],
    closeoutItems: ["Paint schedule", "Color list", "Warranty or attic stock if required"],
    bidFormBreakouts: ["Drywall patching", "Texture", "Primer", "Paint coats", "Protection", "Fire caulk", "Substrate repair allowance"],
    suggestedPrompts: ["Review drywall and paint scope gaps", "Build drywall/paint bidder questions"],
    suggestedTemplates: ["Trade bid form", "Buyout checklist"],
    suggestedChecklist: ["Verify finish level", "Verify patch limits", "Verify rated assemblies", "Verify protection"],
  },
  {
    slug: "doors-hardware",
  ...
  },
  {
    ...
    title: "Appliances",
    trade: "Appliances",
    reviewMode: "Appliances Reviewer",
    summary: "Use when delivery, staging, installation accessories, haul-off, and utility readiness create field and schedule problems.",
    ...
    alternates: ["Appliance package alternate", "Delivery/install alternate"],
    allowances: ["Allowance for re-delivery", "Allowance for utility corrections"],
    changeOrderTriggers: ["Openings do not match selected appliances", "Utilities are not ready", "Delivery access is restricted"],
    inspectionConcerns: ["Anti-tip installation", "Water connections", "Electrical clearances"],
    closeoutItems: ["Serial number list", "Warranty data", "Care manuals"],
    bidFormBreakouts: ["Appliance purchase", "Delivery", "Install", "Connection kits", "Haul-off", "Storage", "Unit pricing"],
    suggestedPrompts: ["Review appliance scope gaps", "Build appliance delivery checklist"],
    suggestedTemplates: ["Trade bid form", "Field issue package"],
    suggestedChecklist: ["Verify install scope", "Verify openings", "Verify utilities", "Verify delivery access"],
  },
  {
    slug: "sitework",
    title: "Sitework",
    trade: "Sitework",
    reviewMode: "Sitework Scope Reviewer",
    summary: "Use when utility conflicts, unsuitable soils, right-of-way work, and weather-sensitive sequencing can create major exposure.",
    ...
    alternates: ["Soil export alternate", "Traffic control alternate"],
    allowances: ["Allowance for unsuitable soils", "Allowance for utility conflict resolution"],
    changeOrderTriggers: ["Unknown utilities", "Unsuitable soils", "Right-of-way restrictions", "Weather-driven rework"],
    inspectionConcerns: ["Compaction testing", "Stormwater controls", "Utility inspections", "Right-of-way restoration"],
    closeoutItems: ["Test reports", "As-built utility records", "Stormwater closeout documentation"],
    bidFormBreakouts: ["Mobilization", "Earthwork", "Utilities", "Storm drain", "Paving", "Traffic control", "Testing", "Unsuitable soils allowance"],
    suggestedPrompts: ["Review sitework scope gaps", "Build sitework bidder questions"],
    suggestedTemplates: ["Trade bid form", "Scope gap matrix"],
    suggestedChecklist: ["Verify utilities", "Verify soils", "Verify permits", "Verify testing"],
  },
  {
    slug: "abatement",
    title: "Abatement",
