  ...
  return (
    <section className="card p-8 sm:p-10">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="eyebrow">SubScope Memory</p>
      ...
      <p className="mt-4 max-w-3xl text-sm leading-6 text-moss">
        This area will eventually remember patterns across GCs, trades, clarification responses, change order issues, bid notes, and lessons learned. For now it uses sample data only.
      </p>
